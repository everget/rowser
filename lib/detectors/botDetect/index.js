...
module.exports = function* botDetect(ua, summary, tmp, strict) {
  ...
  yield /telegrambot\s?(like twitterbot)?/i.test(ua) && {
    bot: t,
    name: 'TelegramBot',
    telegrambot: t,
  }
  ...
  yield /scoutjet|simplepie|covario-ids|findlinks|dataparksearch|larbin|ng-search|snappy|teoma|jeeves|tineye/i.test(ua) && {
    bot: t,
  }
}
