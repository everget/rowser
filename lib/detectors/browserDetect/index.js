 ...
 */
module.exports = function* browserDetect(ua, summary, tmp, strict) {
  yield /edg([ea]|ios)/i.test(ua) && {
    msedge: t,
    name: 'Microsoft Edge',
  ...
  yield /opr\/|opios/i.test(ua) && {
    name: 'Opera',
    opera: t,
    version: getMatchByIndex(1, new RegExp(`(?:opr|opios)[ \/]${DOT_NUMBERS_2}`, 'i'), ua),
  }
  ...
  yield /chromium/i.test(ua) && {
    chromium: t,
    name: 'Chromium',
    version: getMatchByIndex(1, new RegExp(`(?:chromium)[ \/]${DOT_NUMBERS_2}`, 'i'), ua),
  }

  yield /maxthon|mxios/i.test(ua) && {
    maxthon: t,
    name: 'Maxthon',
    version: getMatchByIndex(2, new RegExp(`(?:(maxthon|mxios))[ \/]\\(?${DOT_NUMBERS_1}`, 'i'), ua) || getMatchByIndex(1, reVersion, ua),
  }
  ...
  yield /msie|trident/i.test(ua) && {
    ...
    version: /iemobile/i.test(ua) ? getMatchByIndex(1, new RegExp(`(?:iemobile)[ \/]${DOT_NUMBERS_2}`, 'i'), ua) : getMatchByIndex(1, new RegExp(`(?:msie |rv:)${DOT_NUMBERS_1}`, 'i'), ua),
  }

  yield /puffin/i.test(ua) && {
    name: 'Puffin',
    puffin: t,
    version: getMatchByIndex(1, new RegExp(`(?:puffin)[ \/]${DOT_NUMBERS_2}`, 'i'), ua),
  }
  ...
  yield /palemoon/i.test(ua) && {
    name: 'Pale Moon',
    palemoon: t,
    version: getMatchByIndex(1, new RegExp(`(?:palemoon)[ \/]${DOT_NUMBERS_2}`, 'i'), ua),
  }

  yield /qupzilla/i.test(ua) && {
    name: 'QupZilla',
    qupzilla: t,
    version: getMatchByIndex(1, new RegExp(`(?:qupzilla)[ \/]${DOT_NUMBERS_1}`, 'i'), ua),
  }

  yield /vivaldi/i.test(ua) && {
    name: 'Vivaldi',
    version: getMatchByIndex(1, new RegExp(`vivaldi\/${DOT_NUMBERS_2}`, 'i'), ua),
    vivaldi: t,
  }
  ...
  yield /firefox|iceweasel|fxios|fennec/i.test(ua) && {
    firefox: t,
    name: 'Firefox',
    version: getMatchByIndex(1, new RegExp(`(?:firefox|iceweasel|fxios)[ \/]${DOT_NUMBERS_2}`, 'i'), ua) || getFirstMatch(new RegExp(`fennec\/${DOT_NUMBERS_2}`, 'i'), ua),
  }

  yield /focus/i.test(ua) && {
    firefox: t,
    firefoxfocus: t,
    name: 'Firefox Focus',
    version: getMatchByIndex(1, new RegExp(`focus[ \/]${DOT_NUMBERS_1}`, 'i'), ua),
  }
  ...
  yield /dolfin/i.test(ua) && {
    dolphin: t,
    name: 'Dolphin',
    version: getMatchByIndex(1, new RegExp(`dolfin\/${DOT_NUMBERS_2}`, 'i'), ua),
  }
  ...
  yield /gsa\/\d/i.test(ua) && {
    name: 'Google Search App',
    googlesearchapp: t,
    gsa: t,
    version: getMatchByIndex(1, new RegExp(`gsa\/${DOT_NUMBERS_2}`, 'i'), ua),
  }
  ...
  yield /safari|applewebkit/i.test(ua) && { // (!!~ua.indexOf('Safari') || !!~ua.indexOf('AppleWebKit'))
    name: 'Safari',
    safari: t,
    version: getMatchByIndex(1, reVersion, ua),
  }
